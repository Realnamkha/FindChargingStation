...
const Map = () => {
  return (
    <View className="flex-1 bg-oxford px-6 py-12">
      ...
      {/* Map Placeholder */}
      <View className="flex-1 bg-white rounded-xl justify-center items-center shadow-lg">
      ...
      <TouchableOpacity className="bg-white px-6 py-4 rounded-full w-full mt-6 shadow-lg flex-row justify-center items-center">
        <FontAwesome
          name="map-marker"
          size={20}
          color="#002147"
